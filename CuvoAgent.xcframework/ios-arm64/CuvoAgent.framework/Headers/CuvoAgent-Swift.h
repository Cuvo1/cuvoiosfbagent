...
#ifndef CUVOAGENT_SWIFT_H
#define CUVOAGENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CuvoAgent",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9CuvoAgent15AnimatedControl")
...
SWIFT_CLASS("_TtC9CuvoAgent14AnimatedButton")
...
SWIFT_CLASS("_TtC9CuvoAgent14AnimatedSwitch")
...
SWIFT_CLASS("_TtC9CuvoAgent16AnimationSubview")
...
SWIFT_CLASS("_TtC9CuvoAgent19CompatibleAnimation")
...
SWIFT_CLASS("_TtC9CuvoAgent26CompatibleAnimationKeypath")
...
SWIFT_CLASS("_TtC9CuvoAgent23CompatibleAnimationView")
...
SWIFT_CLASS("_TtC9CuvoAgent32CompatibleDictionaryTextProvider")
...
SWIFT_CLASS("_TtC9CuvoAgent16CuvoAgentManager")
@interface CuvoAgentManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)updateAgentDetailWithKeyWindow:(UIWindow * _Nonnull)keyWindow isDarkTheme:(BOOL)isDarkTheme isCustomButton:(BOOL)isCustomButton ordId:(NSString * _Nonnull)ordId prodId:(NSString * _Nonnull)prodId productVersion:(NSString * _Nonnull)productVersion endPoint:(NSString * _Nonnull)endPoint apiKey:(NSString * _Nonnull)apiKey fontName:(NSString * _Nonnull)fontName languageCode:(NSString * _Nonnull)languageCode completion:(void (^ _Nonnull)(BOOL))completion;
- (void)openFeedbackInfo;
@end
...
SWIFT_CLASS("_TtC9CuvoAgent14DocumentPicker")
...
@interface DocumentPicker (SWIFT_EXTENSION(CuvoAgent)) <UIDocumentPickerDelegate>
...
SWIFT_CLASS("_TtC9CuvoAgent16KeyboardAvoiding")
...
SWIFT_CLASS("_TtC9CuvoAgent22KeyboardDismissingView")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC9CuvoAgent20LottieAnimationLayer")
...
SWIFT_CLASS("_TtC9CuvoAgent23LottieAnimationViewBase")
...
/// </ul>
IB_DESIGNABLE
SWIFT_CLASS("_TtC9CuvoAgent19LottieAnimationView")
...
@interface NSLayoutConstraint (SWIFT_EXTENSION(CuvoAgent))
...
SWIFT_CLASS("_TtC9CuvoAgent23ScreenRecordCoordinator")
@interface ScreenRecordCoordinator : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9CuvoAgent20SwiftyStarRatingView")
...
@interface SwiftyStarRatingView (SWIFT_EXTENSION(CuvoAgent))
